...
export default function Home() {
  ...
  // Toggle body class for wizard state
  useEffect(() => {
    if (wizardOpen) {
  ...
  return (
    <>
      {/* Main App Container - Fluid width */}
      <div id="app" className="w-[94%] max-w-[1200px] mx-auto py-6 transition-all duration-[800ms]" style={{ transitionTimingFunction: "cubic-bezier(0.16, 1, 0.3, 1)" }}>
        {/* Header */}
        <header className="flex justify-between items-center mb-8 px-1 pb-5 border-b" style={{ borderColor: "rgba(0, 82, 204, 0.08)" }}>
          <div>
          ...
          <div className="flex gap-6 items-center text-right">
            <div className="flex flex-col gap-1 min-w-[130px]">
              <span className="text-[0.8rem] font-extrabold uppercase tracking-[1.5px] opacity-70" style={{ color: "#0052CC" }}>
                Lokasi
              </span>
              <p className="text-base font-semibold whitespace-nowrap" style={{ color: "#172B4D" }}>
                MGC Kota Makassar
              </p>
            </div>
            <div className="w-[1.5px] h-8" style={{ background: "rgba(0, 82, 204, 0.1)" }} />
            <div className="flex flex-col gap-1 min-w-[130px]">
              <span className="text-[0.8rem] font-extrabold uppercase tracking-[1.5px] opacity-70" style={{ color: "#0052CC" }}>
                Current Time
              </span>
        ...
        {/* Bento Grid */}
        <main className="bento-grid grid grid-cols-4 gap-3" style={{ gridTemplateRows: "repeat(2, minmax(160px, auto))" }}>
          {/* Main Entrance Card (Spans 2x2) */}
          <article
            className="bento-card col-span-2 row-span-2 text-white !border-none"
            style={{ background: "linear-gradient(145deg, #0052CC, #0747A6)" }}
          >
            <Image
          ...
          <article className="bento-card col-start-3 row-start-1">
            <div className="relative z-[1] h-full flex flex-col">
              ...
              <div className="mt-auto flex gap-1 h-8 items-end">
                ...
                <div className="flex-1 h-[85%] rounded" style={{ background: "#0052CC" }} />
                <div className="flex-1 h-[50%] bg-[#e0eafc] rounded" />
                <div className="flex-1 h-[95%] rounded" style={{ background: "#00B8D9" }} />
              </div>
            </div>
          </article>
          ...
          <article className="bento-card ecosystem-card col-span-2 col-start-3 row-start-2 relative overflow-hidden group">
            ...
            <div className="absolute inset-0 z-0 overflow-hidden">
              ...
              <div className="absolute inset-0 opacity-[0.6] bg-[size:400%_400%]"
                style={{
                  backgroundImage: "radial-gradient(at 0% 0%, rgba(0, 184, 217, 0.15) 0px, transparent 50%), radial-gradient(at 100% 0%, rgba(255, 86, 48, 0.1) 0px, transparent 50%), radial-gradient(at 100% 100%, rgba(0, 82, 204, 0.1) 0px, transparent 50%), radial-gradient(at 0% 100%, rgba(54, 179, 126, 0.1) 0px, transparent 50%)",
              ...
              <div className="absolute inset-0 opacity-[0.2]"
                style={{
                  backgroundImage: "radial-gradient(#0052CC 0.8px, transparent 0.8px)",
            ...
            <div className="flex flex-row h-full relative z-[1]">
              ...
              <div className="flex-1 p-8 flex flex-col justify-center relative">
                ...
                >
                  Lontara
                  <span
                    className="inline-block ml-2 bg-clip-text text-transparent bg-gradient-to-tr from-[#00B8D9] to-[#36B37E] drop-shadow-sm"
                ...
                <a
                  ...
                  className="relative overflow-hidden group flex items-center gap-3 pl-6 pr-6 py-3 bg-[#00B8D9] text-white rounded-2xl shadow-[0_4px_20px_rgba(0,184,217,0.25)] hover:shadow-[0_8px_30px_rgba(0,184,217,0.35)] hover:-translate-y-0.5 transition-all duration-300 w-fit"
                >
              ...
              <div className="w-[42%] relative flex items-center justify-center perspective-[1000px]">
                ...
                >
                  <Image
                    ...
                    style={{ filter: "drop-shadow(0 20px 30px rgba(0, 82, 204, 0.25))" }}
                  />
                  ...
                  <div className="absolute -inset-10 z-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                    ...
                    <div className="absolute bottom-0 left-10 w-32 h-32 bg-[#00B8D9]/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1.5s" }} />
                  </div>
                </div>
              </div>
            </div>
